...
import video from  "../assets/gif.mp4.mp4";
  ...
  return (
    <div className="super-rare">
      <div className="title-container">
        ...
        Memes are a sign of hope for a community which has suffered for far too long.Memes make you laugh, memes make your day,memes love you.DID WE TELL MEMES WILL ALSO BE LAUNCHING AN OFFICIAL MAGAZINE?? SHUSHHHHH
        </h3>
      </div>
      <div className="cards">
